...
```json
{
  "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDY4MTQ3MH0.kIvhW0VEcDORCJaS_L_2Bxhw5A3RjGJGrKqFrrijxUM",
  "token_type": "bearer"
}
```
...
```json
{
  ...
  "method": "POST",
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDY4MTQ3MH0.kIvhW0VEcDORCJaS_L_2Bxhw5A3RjGJGrKqFrrijxUM"
  },
  "data": {
...
```json
{
  "prediction_id": "images-test.jpg_spaghetti_bolognese_20250226_183751_cbe7aae5",
...
```json
{
  ...
  "results": [
    {
      "prediction_id": "multi-image-test.jpg_pancakes_20250226_183751_e7d2ac89",
    ...
    {
      "prediction_id": "multi-image-test-2.jpg_steak_20250226_183751_04202880",
...
```json
{
  ...
  "results": [
    {
      "prediction_id": "images.jpg_spaghetti_bolognese_20250226_183751_d8fc258b",
      "filename": "images.jpg",
      "predicted_class": "spaghetti_bolognese",
      "confidence": 87.35452890396118,
      "top5_predictions": [
    ...
    {
      "prediction_id": "photo_126.jpg_beef_tartare_20250226_183751_05aaa2b1",
