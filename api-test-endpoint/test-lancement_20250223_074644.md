...
```json
{
  "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDM4MzIwM30.RPq_bG3n3tL_YtufUoBGwhXLBKx8DoOma8toswrzIOc",
  "token_type": "bearer"
}
```
...
```json
{
  ...
  "method": "POST",
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDM4MzIwM30.RPq_bG3n3tL_YtufUoBGwhXLBKx8DoOma8toswrzIOc"
  },
  "data": {
...
```json
{
  "prediction_id": "images-test.jpg_20250223_074643_361b5d59",
...
```json
{
  ...
  "results": [
    {
      "prediction_id": "multi-image-test.jpg_20250223_074643_8a39855b",
    ...
    {
      "prediction_id": "multi-image-test-2.jpg_20250223_074644_8b188916",
...
```json
{
  ...
  "results": [
    {
      "prediction_id": "images.jpg_20250223_074644_53aa454d",
      "filename": "images.jpg",
      "predicted_class": "spaghetti_bolognese",
      "confidence": 87.35452890396118,
      "top5_predictions": [
    ...
    {
      "prediction_id": "photo_126.jpg_20250223_074644_6a4ea07c",
...
```json
{
  "status": "\u274c Erreur apprentissage continu: 'NoneType' object has no attribute 'info'",
  "metrics": null,
  "mlflow_run_id": null
}
```
