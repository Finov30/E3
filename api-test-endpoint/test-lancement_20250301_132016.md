...
```json
{
  "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDkyMTYxNX0.OmViSr-3_oHc8s4STwAiPc6ky6SBlqw74RMNjtKTnIg",
  "token_type": "bearer"
}
```
...
```json
{
  ...
  "method": "POST",
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDkyMTYxNX0.OmViSr-3_oHc8s4STwAiPc6ky6SBlqw74RMNjtKTnIg"
  },
  "data": {
...
```json
{
  ...
  "prediction_id": "images-test.jpg_spaghetti_bolognese_20250301_1320_32a1d14e"
}
```
  ...
  "results": [
    {
      ...
      "prediction_id": "multi-image-test.jpg_cannoli_20250301_132015_bc7e21cf",
    ...
    },
    {
      ...
      "prediction_id": "multi-image-test-2.jpg_prime_rib_20250301_132015_9c64e9d9",
