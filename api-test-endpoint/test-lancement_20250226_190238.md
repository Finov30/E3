...
```json
{
  "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDY4Mjk1N30.TmKJ8QJOV6Ko44jvvadyCQAAgjQQnMUfcfaAc1DcL-g",
  "token_type": "bearer"
}
```
...
```json
{
  ...
  "method": "POST",
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDY4Mjk1N30.TmKJ8QJOV6Ko44jvvadyCQAAgjQQnMUfcfaAc1DcL-g"
  },
  "data": {
...
```json
{
  "prediction_id": "images-test.jpg_spaghetti_bolognese_20250226_190237_291b481c",
...
```json
{
  ...
  "results": [
    {
      "prediction_id": "multi-image-test.jpg_beignets_20250226_190237_072288f3",
    ...
    {
      "prediction_id": "multi-image-test-2.jpg_steak_20250226_190237_0ff7a140",
...
```json
{
  ...
  "results": [
    {
      "prediction_id": "images.jpg_spaghetti_bolognese_20250226_190238_ebd0452e",
      "filename": "images.jpg",
      "predicted_class": "spaghetti_bolognese",
      "confidence": 99.08921718597412,
      "top5_predictions": [
    ...
    {
      "prediction_id": "photo_126.jpg_spaghetti_bolognese_20250226_190238_6389af79",
...
```json
{
  "detail": "Erreur lors du traitement du feedback: 'ContinuousLearningManager' object has no attribute 'add_feedback'"
}
```
