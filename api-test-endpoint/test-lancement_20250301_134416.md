...
```json
{
  "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDkyMzA1NX0.BmvDnhpHD5BYPNcJxKDJF1kdmjDH3fiPzDwQINf2rFo",
  "token_type": "bearer"
}
```
...
```json
{
  ...
  "method": "POST",
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDkyMzA1NX0.BmvDnhpHD5BYPNcJxKDJF1kdmjDH3fiPzDwQINf2rFo"
  },
  "data": {
...
```json
{
  ...
  "prediction_id": "images-test.jpg_spaghetti_bolognese_20250301_1344_74769b03"
}
```
  ...
  "results": [
    {
      ...
      "prediction_id": "multi-image-test.jpg_cannoli_20250301_134416_63e1d1c7",
    ...
    },
    {
      ...
      "prediction_id": "multi-image-test-2.jpg_prime_rib_20250301_134416_aa4fc9d1",
