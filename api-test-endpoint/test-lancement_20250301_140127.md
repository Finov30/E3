...
```json
{
  "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDkyNDA4N30.2B0XUyh-pI2HYbpP575Dfe4_19SOU-n6e5BDAWNBFs0",
  "token_type": "bearer"
}
```
...
```json
{
  ...
  "method": "POST",
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDkyNDA4N30.2B0XUyh-pI2HYbpP575Dfe4_19SOU-n6e5BDAWNBFs0"
  },
  "data": {
...
```json
{
  ...
  "prediction_id": "images-test.jpg_spaghetti_bolognese_20250301_1401_90fa310e"
}
```
  ...
  "results": [
    {
      ...
      "prediction_id": "multi-image-test.jpg_cannoli_20250301_140127_da21ded4",
    ...
    },
    {
      ...
      "prediction_id": "multi-image-test-2.jpg_prime_rib_20250301_140127_743f5335",
