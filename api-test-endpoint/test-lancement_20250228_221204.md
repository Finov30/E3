...
```json
{
  "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDg2NzEyM30.ZBW5w1wXD-l0d6VeIcaGgTsxZzH8OxTW8l6G-3w97b0",
  "token_type": "bearer"
}
```
...
```json
{
  ...
  "method": "POST",
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImV4cCI6MTc0MDg2NzEyM30.ZBW5w1wXD-l0d6VeIcaGgTsxZzH8OxTW8l6G-3w97b0"
  },
  "data": {
...
```json
{
  ...
  "prediction_id": "images-test.jpg_spaghetti_bolognese_20250228_2212_2da3a535"
}
```
...
```json
{
  ...
  "results": [
    {
      "prediction_id": "multi-image-test.jpg_cannoli_20250228_221204_9d4f933b",
    ...
    {
      "prediction_id": "multi-image-test-2.jpg_prime_rib_20250228_221204_044e8042",
...
```json
{
  ...
  "results": [
    {
      "prediction_id": "images.jpg_spaghetti_bolognese_20250228_221204_43a3e849",
      "filename": "images.jpg",
      "predicted_class": "spaghetti_bolognese",
      "confidence": 99.99854564666748,
      "top5_predictions": [
    ...
    {
      "prediction_id": "photo_126.jpg_spaghetti_bolognese_20250228_221204_ec8e13a6",
...
```json
{
  "detail": "Erreur lors du traitement du feedback: name 'feedback_cache' is not defined"
}
```
